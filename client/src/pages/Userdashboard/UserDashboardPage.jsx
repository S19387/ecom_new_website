...
import ChatPage from "../../components/EchoOS/chatMain";
...
const UserDashboardPage = () => {
  ...
  }, [selectedTab, user.id]); // Updated dependency array
  ...
  return (
    <div className="flex min-h-screen overflow-hidden bg-[#f0f4fc]">
      <SideBar
                ...
                <div className="flex flex-col space-y-4">
                  {stats.totalTasks > 0 ? (
                    ...
                    <div className="text-sm text-gray-500 italic mb-2">
                      No tasks assigned yet. Task completion metrics will appear
                      here once you have tasks.
                    </div>
                  )}
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        {stats.moodAverage
                          ? `${Math.round((stats.moodAverage / 5) * 100)}%`
                          : "N/A"}
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
